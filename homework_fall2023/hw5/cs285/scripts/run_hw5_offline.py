...
from hw5.cs285.agents import agents
from hw5.cs285.infrastructure import utils
from hw5.cs285.infrastructure.logger import Logger
from hw5.cs285.infrastructure.replay_buffer import MemoryEfficientReplayBuffer, ReplayBuffer
...
def main():
    ...
    # create directory for loggin

    config = make_config(args.config_file)
    logdir_prefix = f"hw5_offline_{config['exp_name']}_"  # keep for autograder
