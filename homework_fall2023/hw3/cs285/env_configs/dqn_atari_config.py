...
from hw3.cs285.infrastructure.atari_wrappers import wrap_deepmind
...
def atari_dqn_config(
    ...
    **kwargs,
    ...
    # 学习率调度器
    # make_lr_schedule用于动态调整学习率。
    # PiecewiseSchedule定义了学习率的变化方式，分阶段逐步衰减：
    # 初始阶段（0 - 20000步），学习率保持为1。
    # 之后逐步衰减，直到达到总步数的一半时为0.5倍。
